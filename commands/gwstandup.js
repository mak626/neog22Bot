...
module.exports = {
    name: 'gwstandup',
    usage: `${PREFIX}gwstandup <@user-name> [mark]`,
    description: 'Grades standup mark to a user from server',
    faculty: true,
    ...
    async execute(message, args, client) {
        ...
        embed = new Discord.MessageEmbed()
            ...
            .setDescription(`Thank you for grading ${taggedUser} \`${points}\` standup points`);
