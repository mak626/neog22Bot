...
module.exports = {
    name: 'gwproject',
    usage: `${PREFIX}gwproject <@user-name> [mark]`,
    ...
    async execute(message, args, client) {
        ...
        embed
            ...
            .setDescription(`${authorUser} awarded ${taggedUser} \`${points}\` project points`)
        ...
        embed = new Discord.MessageEmbed()
            ...
            .setDescription(`Thank you for grading ${taggedUser} \`${points}\` project points`);
