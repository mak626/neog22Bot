...
module.exports = {
    name: 'gwdebug',
    usage: `${PREFIX}gwdebug <@user-name> [mark]`,
    ...
    async execute(message, args, client) {
        ...
        embed
            ...
            .setDescription(`${authorUser} awarded ${taggedUser} \`${points}\` debugging points`)
        ...
        embed = new Discord.MessageEmbed()
            ...
            .setDescription(`Thank you for grading ${taggedUser} \`${points}\` debugging points`);
