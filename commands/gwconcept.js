...
module.exports = {
    name: 'gwconcept',
    usage: `${PREFIX}gwconcept <@user-name> [mark]`,
    ...
    async execute(message, args, client) {
        ...
        embed = new Discord.MessageEmbed()
            ...
            .setDescription(`Thank you for grading ${taggedUser} \`${points}\` concepts points`);
