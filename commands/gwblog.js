...
module.exports = {
    name: 'gwblog',
    usage: `${PREFIX}gwblog <@user-name> [mark]`,
    ...
    async execute(message, args, client) {
        ...
        embed
            ...
            .setDescription(`${authorUser} awarded ${taggedUser} \`${points}\` blog points`)
        ...
        embed = new Discord.MessageEmbed()
            ...
            .setDescription(`Thank you for grading ${taggedUser} \`${points}\` blog points`);
